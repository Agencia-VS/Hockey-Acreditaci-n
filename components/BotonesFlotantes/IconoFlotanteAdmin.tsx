    ...
    <>
      ...
      >
        <div className="bg-white/20 backdrop-blur-md hover:bg-white/30 transition-all p-3 rounded-full border border-white/30 hover:scale-110 flex items-center justify-center group-hover:gap-2">
          ...
          <span className="text-white text-sm font-medium pr-1 opacity-0 group-hover:opacity-100 w-0 group-hover:w-auto transition-all duration-300 overflow-hidden whitespace-nowrap">Admin</span>
        </div>
      </Link>
    </>
  );
